...
## Object向けの関数群
以下に示す関数群は**assignを除き**全て **非破壊的** な関数です(assignも第１引数に空オブジェクトを指定することで非破壊的に使えます)。lodashは基本的に非破壊的なものが多いですが、まれに引数で渡したものを書きかえてしまうものがあるので注意して下さい。出来る限り、非破壊的な関数を使う方向に寄せたほうが良いと思います。
